...
url: https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html
published: "2020-02-05T00:00:00Z"
feed: travisdowns
guid: https://travisdowns.github.io/blog/2020/02/05/now-with-comments
---

# Adding Staticman Comments

I’ve added comments to my blog. You can find the existing comments, if any, and the new comment form [at the bottom](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#comment-section) of any post.
...
- [Table of Contents](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#table-of-contents)
- [Introduction](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#introduction)
- [Set Up GitHub Bot Account](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#set-up-github-bot-account)
  - [Generate Personal Access Token](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#generate-personal-access-token)
- [Set Up the Blog Repository Configuration](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#set-up-the-blog-repository-configuration)
  - [Configuring staticman.yml](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#configuring-staticmanyml)
  - [Configuring \_config.yml](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#configuring-_configyml)
- [Set Up the API Bridge](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#set-up-the-api-bridge)
  - [Generate an RSA Keypair](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#generate-an-rsa-keypair)
  - [Sign Up for Heroku](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#sign-up-for-heroku)
  - [Deploy Staticman Bridge to Heroku](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#deploy-staticman-bridge-to-heroku)
  - [Configure Bridge Secrets](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#configure-bridge-secrets)
- [Invite and Accept Bot to Blog Repo](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#invite-and-accept-bot-to-blog-repo)
- [Enable reCAPTCHA](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#enable-recaptcha)
  - [Sign Up for reCAPTCHA](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#sign-up-for-recaptcha)
  - [Configure reCAPTCHA](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#configure-recaptcha)
- [Integrate Comments Into Site](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#integrate-comments-into-site)
  - [Markdown Part](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#markdown-part)
- [Testing on This Post](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#testing-on-this-post)
- [Thanks](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#thanks)
- [References](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#references)
...
2. Javascript[1](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:backup) attached to the form submits it to my _staticman API bridge[2](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:bridge)_ running on Heroku.
...
4. When I accept the pull request, it triggers a regeneration and republishing of the content (this is a GitHub pages feature), so the reply appears almost immediately[3](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:cache).
...
- There are three version of the staticman API: v1, v2 and v3. This guide uses v2 (although v3 is almost identical[4](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:v3)), but the v1 version is considerably different.
...
![Repo scope](https://travisdowns.github.io/assets/now-with-comments/scopes-repo.png)

**User scope:**

![User scope](https://travisdowns.github.io/assets/now-with-comments/scopes-user.png)
...
Don’t use any passphrase[5](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:pass). You can change the `-f` argument if you want to save the key somewhere else, in which case you’ll have to use the new location when setting up the Heroku config below.
...
[Sign up](https://signup.heroku.com/) for a free account on Heroku. No credit card is required and a free account should give you enough juice for at least 1,000 comments a month[6](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:juice).
...
![Deploy](https://travisdowns.github.io/assets/now-with-comments/deploy.png)
...
If you want, you can add both of these through the Heroku web dashboard: go to Settings -> Reveal Config Vars, and enter them [like this](https://travisdowns.github.io/assets/now-with-comments/config-vars.png)).
...
Finally, you need to invite your GitHub _bot account_ that you created earlier to your blog repository[7](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:whycollab) and accept the invite.
...
![Adding Collaborators](https://travisdowns.github.io/assets/now-with-comments/add-collab.png)

Next, accept[8](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fn:invite) the invitation using the bridge API, by going to the following URL:
...
If you want to leave a non-trivial comment on the content of this post, you can do so below. However, if you’d instead like to make a “just testing” post, to see how the http request works, or check the created pull request, etc, please do it [over here](https://travisdowns.github.io/misc/comments-test.html). Testing only comments made on this post will be closed without accepting them.
...
1. If javascript is disabled, a regular POST action takes over. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:backup)

2. I don’t think you’ll find this _bridge_ term in the official documentation, but I’m going to use it here. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:bridge)

3. Well, subject to whatever edge caching GitHub pages is using – btw you can bust the cache by appending any random query parameter to the page: `...post.html?foo=1234`. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:cache)

4. v3 mostly just extends to the URL format for the `/event` endpoint to include the hosting provider (either GitHub or GitLab), allowing the use of GitHub in addition to GitLab. Almost everything in this guide would remain unchanged. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:v3)

5. You could use a passphrase, but then you’ll have to change the `cat` used below to echo the key into the Heroku config. If you want to be super safe, best is to generate the key to a transient location like ramfs and then simply delete the private portion after you’ve uploaded it to the Heroku config. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:pass)

6. In particular, the _unverified_ (no credit card) free tier gives you 550 hours of uptime a month, and since the _dyno_ (heroku speak for their on-demand host) sleeps after 30 minutes, I figure you can handle 550/0.5 = 1100 sparsely submitted comments. Of course, if comments come in bursts, you could handle much more than that, since you’ve already “paid” for the 30 minute uptime. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:juice)

7. The bot needs to be a collaborator to, at a minimum, commit comments to the repository, and to delete branches (using the delete branches webhook which cleans up comment related branches). However, it is possible to not use either of these features if you have moderation enabled (in which case comments arrive as a PR, which doesn’t require any particular permissions), and aren’t using the webhook. So maybe you could do without the collaborator status in that case? I haven’t tested it. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:whycollab)

8. I guess you can also just accept the invitation by opening the email sent to you by github and following the link there. This workflow involving the `v2/connect` endpoint probably made more sense when the API was meant to be shared among many uses using a common github bot account. [↩](https://travisdowns.github.io/blog/2020/02/05/now-with-comments.html/#fnref:invite)
