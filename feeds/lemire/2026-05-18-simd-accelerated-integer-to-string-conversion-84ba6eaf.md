---
title: SIMD-accelerated integer-to-string conversion
url: https://lemire.me/blog/2026/05/18/simd-accelerated-integer-to-string-conversion/
published: "2026-05-18T19:39:49Z"
feed: lemire
guid: https://lemire.me/blog/?p=22639
---

# SIMD-accelerated integer-to-string conversion

![](https://lemire.me/blog/wp-content/uploads/2026/05/Gemini_Generated_Image_bzgphmbzgphmbzgp-150x150.png)
...
Thankfully, even if you, say, need only six digits, you can do the full 8-digit computation and then use a _masked store_ if you want to store only six digits, ignoring the two leftovers. That is, instruction sets like AVX-512 allow you to write only some of the data to memory, which is quite convenient.
...
[![](http://lemire.me/blog/wp-content/uploads/2026/05/graph-1024x606.png)](http://lemire.me/blog/wp-content/uploads/2026/05/graph.png)

**Further reading**

– The paper: [doi:10.1002/spe.70079]( https://doi.org/10.1002/spe.70079)
