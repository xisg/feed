...
2. A software library supporting _static reflection_ like simdjson.
...
Recent versions of [simdjson](https://github.com/simdjson/simdjson) can parse JSON _at compile time_ using C++26 static reflection. The entry point is `simdjson::compile_time::parse_json`, and it does something I still find slightly magical: it reads the JSON and, from the keys it finds, and synthesises the struct type for you.
...
_Reference_: [P2996 — Reflection for C++26](https://wg21.link/p2996) and [the simdjson library](https://simdjson.org).

_Credit_: The simdjson implementation is joint work with Francisco Geiman Thiesen.
