...
feed: knuth
guid: https://www-cs-faculty.stanford.edu/~knuth/email.html
---
...
Sometimes I do send email, through my secretary, with respect to the project I'm currently working on, when I believe that the recipient won't be bothered by my request. But I hope you can understand why I am almost always unhappy to receive unsolicited email myself. Thank you for your patience and cooperation as I try to finish The Art of Computer Programming ([TAOCP](https://www-cs-faculty.stanford.edu/~knuth/taocp.html)), a work that I began in 1962 and that I will need many years to complete. In return, I promise not to send unwelcome email requests to you.
