...
published: "2024-02-04T23:11:21Z"
feed: andrewkelley
guid: https://andrewkelley.me/post/why-we-cant-have-nice-software.html
---
...
and just a _trickle_ of electricity to run it.
...
then, once again, it's _done_; ripples disappearing from the surface of
a lake hours after a stone is thrown into it.

The darker side of bitrot is due to businesses trying to make **more profit**
**than last year**, and launching marketing initiatives. For example, Microsoft
...
It's all so incredibly _wasteful_.
...
perhaps _especially_ competitors, to have interchangeable components with each
...
[EU formally adopting a law requiring Apple to support USB-C chargers](https://www.cnn.com/2022/10/24/tech/eu-law-charging-standard/index.html). At the time of writing there is no such law in the United States, but it is [being discussed by politicians](https://techcrunch.com/2022/06/17/senators-call-for-us-to-adopt-common-charger).
...
[to decay](https://www.eff.org/deeplinks/2023/04/platforms-decay-lets-put-users-first). I can't believe a human sat down and wasted hours of their life coding "super reactions". It's
...
_what would these employees spend their time on?_ At some point society
...
to make _more profit than last year_? By any means necessary, of course.
...
**actively sabotage the dishwasher's prewash feature** making the product
...
improve your product any more, _you still have to change something_.
...
work it creates for everyone to do. The waste is a feature; it's how the [line goes up](https://www.youtube.com/watch?v=YQ_xWvX1n9g).
...
> Now take this empty glass. Here it is: peaceful, serene, _boring_. But if
...
For investors, all this churn is attractive. It's _disruptive_.

It's why we can't have nice software.

## Conclusion

Technology, and in particular, software, offers a glimpse of magic; a
