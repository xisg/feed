...
feed: huyenchip
guid: https://huyenchip.com/2025/01/07/agents.html
---
...
![A coding agent](/assets/pics/agents/1-swe-agent.png) Figure 6-8. SWE-agent is a coding agent whose environment is the computer and whose actions include navigation, search, view files, and editing
...
![Agent pattern](/assets/pics/agents/2-agent-pattern.png) Figure 6-9. Decoupling planning and execution so that only validated plans are executed
...
![An example of function calling](/assets/pics/agents/3-function-calling.png) Figure 6-10. An example of a model using two simple tools
...
![Agent control flow](/assets/pics/agents/4-agent-control-flow.png) Figure 6-11. Examples of different orders in which a plan can be executed
...
![ReAct example](/assets/pics/agents/5-ReAct.png) Figure 6-12: A ReAct agent in action.
...
![Reflexion example](/assets/pics/agents/6-reflexion.png) Figure 6-13. Examples of how Reflexion agents work.
...
![Different models have different tool preferences](/assets/pics/agents/7-tool-preference.png) Figure 6-14. Different models and tasks express different tool use patterns.
...
![Tool transition](/assets/pics/agents/8-tool-transition.png) Figure 6-15. A tool transition tree by Chameleon (Lu et al., 2023).
