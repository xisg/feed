...
url: https://blog.llvm.org/posts/2024-10-23-out-of-process-execution-for-clang-repl/
published: "2024-11-04T00:00:00Z"
feed: llvm
guid: https://blog.llvm.org/posts/2024-10-23-out-of-process-execution-for-clang-repl/
---
...
- **New Command-Line Flags**:
  ...
  - **`--oop-executor`** This flag starts a separate JIT executor process. The executor handles the actual code execution independently of the main Clang-Repl process.

  - **`--oop-executor-connect`** This flag establishes a communication link between Clang-Repl and the out-of-process executor. It allows Clang-Repl to transmit code to the executor and retrieve the results from the execution.
...
- **Block Dependence Calculation in ObjectLinkingLayer** [Commit Link](https://github.com/llvm/llvm-project/commit/896dd322afcc1cf5dc4fa7375dedd55b59001eb4)
...
1. **Incremental Initializer Execution for Mach-O and ELF** **PRs**: [#97441](https://github.com/llvm/llvm-project/pull/97441), [#110406](https://github.com/llvm/llvm-project/pull/110406)
...
2. **Push-Request Model for ELF Initializers** **PR**: [#102846](https://github.com/llvm/llvm-project/pull/102846)
...
2. **Refactor of `dlupdate` Function** **PR**: [#110491](https://github.com/llvm/llvm-project/pull/110491)
