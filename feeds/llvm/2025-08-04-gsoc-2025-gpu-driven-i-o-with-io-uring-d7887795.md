...
url: https://blog.llvm.org/posts/2025-08-04-gpu-io-uring/
published: "2025-08-04T00:00:00Z"
feed: llvm
guid: https://blog.llvm.org/posts/2025-08-04-gpu-io-uring/
---

# GSoC 2025: GPU-driven I/O with io_uring

Hello everyone! My name is Rodrigo Ceccato, and for GSoC 2025 I’ve been working on GPU-driven I/O using `io_uring`. This 8-week project focuses on developing a prototype of a printf-like interface for the GPU, backed by Shared Virtual Memory (SVM) to directly access the io\_uring submission queue.
...
![GPU writes to mailbox.](https://blog.llvm.org/img/gpulibc_rpc.png)
...
![GPU writes to an io_uring queue in SVM; the kernel prints the text.](https://blog.llvm.org/img/gpulibc_uring.png)
