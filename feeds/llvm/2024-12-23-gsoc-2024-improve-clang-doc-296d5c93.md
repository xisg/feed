...
url: https://blog.llvm.org/posts/2024-12-04-improve-clang-doc/
published: "2024-12-23T00:00:00Z"
feed: llvm
guid: https://blog.llvm.org/posts/2024-12-04-improve-clang-doc/
---
...
```cpp
//File: Base.hclass Base {}
```

```cpp
//File: A.cpp#include "Base.h"...
```

```cpp
//File: B.cpp#include "Base.h"...
```
...
![](https://blog.llvm.org/img/clang-doc-benchmark-numbers.png)
...
![](https://blog.llvm.org/img/clang-doc-concurrency.png)
...
![](https://blog.llvm.org/img/clang-doc-old-html-output.png)

![](https://blog.llvm.org/img/clang-doc-new-output.png)

You can also visit the output project on my github.io page link [here](https://peterchou1.github.io/).
