...
url: https://smallcultfollowing.com/babysteps/blog/2012/02/25/serialization-without-type-information-via-impls/?utm_source=atom_feed
published: "2012-02-25T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/02/25/serialization-without-type-information-via-impls/
---
...
field `span`: here, we don’t even _try_ resolve the identifier, we
...
- if the type of a field is parameterized, like `spanned<item_>`, then
  we generate a call like `deserialize_spanned(d, {|| deserialize_item_(d) })`, where the sugared closure `{||...}`
