...
url: https://smallcultfollowing.com/babysteps/blog/2013/11/21/optimizing-simd/?utm_source=atom_feed
published: "2013-11-21T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/11/21/optimizing-simd/
---

# Optimizing SIMD

There is currently some [ongoing effort](https://bugzilla.mozilla.org/show_bug.cgi?id=904913&sourceid=Mozilla-search) to implement the
proposed [JavaScript SIMD API](http://wiki.ecmascript.org/doku.php?id=strawman:simd_number) in Firefox. The basic idea of the
...
that they are _values_ and hence do not have identity. Basically
...
The basic strategy is similar to the [existing optimizations](https://smallcultfollowing.com/babysteps/
/blog/2013/11/04/optimizing-complex-typed-object-assignments/)
...
[loadTypedObjectElements()](http://dxr.mozilla.org/mozilla-central/source/js/src/jit/IonBuilder.cpp#9631) for the purpose of optimizing out
derived temporaries.
...
performed if all producers _and_ consumers expect float32, and not
