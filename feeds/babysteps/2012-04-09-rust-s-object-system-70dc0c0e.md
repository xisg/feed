...
url: https://smallcultfollowing.com/babysteps/blog/2012/04/09/rusts-object-system/?utm_source=atom_feed
published: "2012-04-09T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/04/09/rusts-object-system/
---

# Rust's object system

On the `rust-dev` mailing list, someone pointed out another
[“BitC retrospective” post by Jonathon Shapiro concerning typeclasses](http://www.bitc-lang.org/pipermail/bitc-dev/2012-April/003315.html).
...
One caveat: I _think_ that these techniques are novel, at least in
...
to the instance data along with a [vtable](http://en.wikipedia.org/wiki/Virtual_method_table). Invoking the `draw`
...
(typically using [PICs](http://en.wikipedia.org/wiki/Inline_caching) or similar things) but we want to be able
...
iface. This `draw` interface is called the _bound_ of the type
...
but you cannot have a vector containing both a square _and_ a circle.
...
a vector containing _both_ circles and squares. In fact, there can be
...
unfortunate, because it ties together the sub _typing_ relationship
