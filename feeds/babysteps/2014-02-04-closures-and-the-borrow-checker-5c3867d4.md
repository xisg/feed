...
url: https://smallcultfollowing.com/babysteps/blog/2014/02/04/closures-and-the-borrow-checker/?utm_source=atom_feed
published: "2014-02-04T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2014/02/04/closures-and-the-borrow-checker/
---
...
The basic idea is that the borrow checker will treat a closure _as if_
...
explicit pair `(&mut env, callback)` that combines the _environment_
...
had read – and this message _must_ be sent, even if you fail
...
_still_ mutate the cell’s contents using the `get()` and `set()`
...
[issue-6801-borrowck-closures](https://github.com/nikomatsakis/rust/tree/issue-6801-borrowck-closures/). It is currently passing tests and
