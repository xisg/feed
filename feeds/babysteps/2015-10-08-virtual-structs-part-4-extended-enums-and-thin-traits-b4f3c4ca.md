...
url: https://smallcultfollowing.com/babysteps/blog/2015/10/08/virtual-structs-part-4-extended-enums-and-thin-traits/?utm_source=atom_feed
published: "2015-10-08T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2015/10/08/virtual-structs-part-4-extended-enums-and-thin-traits/
---

# Virtual Structs Part 4: Extended Enums And Thin Traits

So, aturon wrote this [interesting post](http://aturon.github.io/blog/2015/09/18/reuse/) on an alternative
...
Aaron’s proposal as [the Thin Traits proposal](http://aturon.github.io/blog/2015/09/18/reuse/), and my own
previous proposal as [the Extended Enums proposal](http://smallcultfollowing.com/babysteps/blog/2015/08/20/virtual-structs-part-3-bringing-enums-and-structs-together/). Very good.
...
on [this Rust internals thread](https://internals.rust-lang.org/t/blog-post-extended-enums-and-thin-traits/2755).)

### Conclusion

Let me lead with my conclusion: **while I still want the Extended**
**Enums proposal, I _lean_ towards implementing the Thin Traits**
...
[specialization](https://github.com/rust-lang/rfcs/pull/1210), which I want for a wide variety of reasons, we
_almost_ get Thin Traits for free. And the Thin Traits pattern is
...
(though for that I think I would favor something like [RFC 757](https://github.com/rust-lang/rfcs/pull/757)).
...
[Extended Enums proposal](http://smallcultfollowing.com/babysteps/blog/2015/08/20/virtual-structs-part-3-bringing-enums-and-structs-together/). Extended Enums, as you may recall,
...
In order to support the [abstraction of constructors](http://smallcultfollowing.com/babysteps/blog/2015/05/29/classes-strike-back/#problem-3-initialization-of-common-fields), the
proposal includes a special associated type that lets you pull out a
struct [containing the common fields from an enum](http://smallcultfollowing.com/babysteps/blog/2015/08/20/virtual-structs-part-3-bringing-enums-and-structs-together/#associated-structs-constructors). For
...
not an impl _of_ the trait `Node`, but rather adding inherent methods
...
Aaron gave a [quick summary in the Thin Trait proposal](http://aturon.github.io/blog/2015/09/18/reuse/#ending-2:-the-enum-based-approach). I
...
_why_ it is that we expand the one impl (for `Option<T>`) into two
...
- The `impl` itself handles the “virtual” dispatch part of things. We
  ...
  expanded builtin [PIC](https://en.wikipedia.org/wiki/Inline_caching#Polymorphic_inline_caching)).
...
avoid it. We did so by introducing a new shorthand, called `match impl`. This would basically create the “downcasting” impl that we
...
that impl automatically, as part of the [object safety](http://huonw.github.io/blog/2015/01/object-safety/) notion.
...
What you _can_ do in the Thin Traits proposal is to add methods to the
...
[expression problem](https://en.wikipedia.org/wiki/Expression_problem). With Extensible Enums, we enumerated all the
