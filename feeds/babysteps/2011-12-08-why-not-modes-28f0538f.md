---
title: Why not modes?
url: https://smallcultfollowing.com/babysteps/blog/2011/12/08/why-not-modes/?utm_source=atom_feed
published: "2011-12-08T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2011/12/08/why-not-modes/
---

# Why not modes?

[Marijn](http://marijnhaverbeke.nl/) asked me what it is that I dislike about parameter
...
and we could replace the call `foo(&v1, &v2)` with `timer(wrap2(foo), (&v1, &v2))` with no change in the semantics.
