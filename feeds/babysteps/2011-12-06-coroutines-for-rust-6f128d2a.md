...
url: https://smallcultfollowing.com/babysteps/blog/2011/12/06/coroutines-for-rust/?utm_source=atom_feed
published: "2011-12-06T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2011/12/06/coroutines-for-rust/
---
...
it anywhere else (it could safely _swap_ the pointer): if it did do
...
_procedures_. A procedure is basically a one-shot closure.
...
> _As an aside:_ this approach cannot accomodate modes. But I want to
...
Procedures are actually a simplification of full-fledged _coroutines_
(a.k.a., _iterators_, _delimited continuations_, and many other
names). The main difference is that, whereas a procedure executes
once, a coroutine can _yield_ an arbitrary number of times back to its
...
The cool thing about coroutines is that they separate out _context_
_switching_ from _parallelism_. They would provide us with a path to
...
implement, and they may not be fast enough to _really_ use for
