...
url: https://smallcultfollowing.com/babysteps/blog/2012/12/05/self-hosted-parallel-js/?utm_source=atom_feed
published: "2012-12-05T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/12/05/self-hosted-parallel-js/
---

# Self-hosted Parallel JS

The blog has been silent for a while. The reason is that I’ve been
hard at work on [Parallel JS](https://smallcultfollowing.com/babysteps/
/blog/categories/pjs). It’s come a long way: in fact,
...
_self-hosting_ implementation. Self-hosting is a very cool new
direction for the SpiderMonkey engine being introduced by
[Till Schneidereit](http://www.tillschneidereit.de). The idea is to implement large parts of
the engine itself in JavaScript, similar to projects like
[Squeak](http://www.squeak.org/), [Jikes RVM](http://www.research.ibm.com/jalapeno/publication.html), [Maxine](http://labs.oracle.com/projects/maxine/), [PyPy](http://pypy.org/) and numerous
...
[80 lines of C++ code](https://github.com/mozilla/mozilla-central/blob/7ca138ebf9ab8f0f1e981af486b9af6206fd0d15/js/src/jsarray.cpp#L2943). This function must handle all sorts of
annoying conditions, such as [ensuring that objects are rooted](https://github.com/mozilla/mozilla-central/blob/7ca138ebf9ab8f0f1e981af486b9af6206fd0d15/js/src/jsarray.cpp#L2948),
[checking for interrupts](https://github.com/mozilla/mozilla-central/blob/7ca138ebf9ab8f0f1e981af486b9af6206fd0d15/js/src/jsarray.cpp#L2986), and using an
[optimized call sequence to make it faster to invoke the JS code](https://github.com/mozilla/mozilla-central/blob/7ca138ebf9ab8f0f1e981af486b9af6206fd0d15/js/src/jsarray.cpp#L2983).
...
`Array.map` is that it is _slow_. This may seem surprising. Isn’t
...
array store in JavaScript _can be_ a significant more complex
operation. Therefore, the C++ equivalent is a
[call to the JS VM function `SetArrayElement()`](https://github.com/mozilla/mozilla-central/blob/7ca138ebf9ab8f0f1e981af486b9af6206fd0d15/js/src/jsarray.cpp#L3006).
...
self-hosting introduces the idea of _intrinsic function_. An
