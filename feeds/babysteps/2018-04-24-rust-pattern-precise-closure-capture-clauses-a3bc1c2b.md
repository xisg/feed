...
url: https://smallcultfollowing.com/babysteps/blog/2018/04/24/rust-pattern-precise-closure-capture-clauses/?utm_source=atom_feed
published: "2018-04-24T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2018/04/24/rust-pattern-precise-closure-capture-clauses/
---
...
- [Rooting an rc handle](https://smallcultfollowing.com/babysteps/
  /blog/2018/04/16/rust-pattern-rooting-an-rc-handle/)
...
However, this code [will not compile](https://play.rust-lang.org/?gist=62c47ef4198dbb1c8dc2a22ea7c961a0&version=stable):
...
but rather a for loop, [everything builds](https://play.rust-lang.org/?gist=9d212e98a66a27c4a95790b9b9c3f30d&version=stable):
...
_immediately_ – rather, it executes later, each time the closure is
...
this series](https://smallcultfollowing.com/babysteps/
/blog/2018/04/16/rust-pattern-rooting-an-rc-handle/), the compiler only sees one function at a time,
...
As you can [verify for yourself](https://play.rust-lang.org/?gist=149ccc90dd732496467f43d2a44532b8&version=stable), this code compiles.
...
Or, [in context](https://play.rust-lang.org/?gist=8ea9d6acddfc11706fda29bde8550f3c&version=stable):
...
In effect, these `let` statements become like the [“capture clauses”](https://msdn.microsoft.com/en-us/library/dd293608.aspx)
...
Another time that this pattern is useful is when you want to capture a _clone_
...
There is actually a pending RFC, [RFC #2229](https://github.com/rust-lang/rfcs/pull/2229), that aims to modify
