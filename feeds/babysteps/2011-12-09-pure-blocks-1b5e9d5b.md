---
title: Pure blocks
url: https://smallcultfollowing.com/babysteps/blog/2011/12/09/pure-blocks/?utm_source=atom_feed
published: "2011-12-09T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2011/12/09/pure-blocks/
---
...
just like `immutable` and `shared` in [D](http://d-programming-language.org/). The type `const T`
...
Given this tool, the basic idea is that a parallel block (written `{ par || }`) can access its surrounding environment, but all of the
...
_Also:_ here I am assuming fixed-length arrays, not the “always
...
McCool on [Structured Parallel Programming](http://www.usenix.org/events/hotpar10/tech/techAbstracts.html#McCool) would be a good
