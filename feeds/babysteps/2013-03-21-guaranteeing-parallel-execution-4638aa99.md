...
url: https://smallcultfollowing.com/babysteps/blog/2013/03/21/guaranteeing-parallel-execution/?utm_source=atom_feed
published: "2013-03-21T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/03/21/guaranteeing-parallel-execution/
---
...
to offer methods whose definition makes parallel execution _possible_,
...
I wrote in my [preivous post](https://smallcultfollowing.com/babysteps/
/blog/2013/03/20/parallel-js-lands/), I want to do this both via
...
Nonetheless, I do not think that the _formal specification_ of
...
the _full JavaScript language_ might be accepted. If you think that’s
science fiction, consider that
[newer Intel chips will have hardware support for a limited form of transactional memory](http://en.wikipedia.org/wiki/Transactional_Synchronization_Extensions).
...
I find the precedent of [asm.js](http://asmjs.org/) to be a more promising
...
[“equivalent to some sequential execution”](https://smallcultfollowing.com/babysteps/
/blog/2013/01/02/deterministic-or-not/), and I still think
...
_very_ narrow slice of JS intended to be output by compilers, not by
...
precedent. Smart folk working on projects like [Emscripten](https://github.com/kripken/emscripten) and
[Mandreel](http://www.mandreel.com/) have already done a lot of the leg work to define the
