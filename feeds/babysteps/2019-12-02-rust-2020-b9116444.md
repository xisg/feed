---
title: Rust 2020
url: https://smallcultfollowing.com/babysteps/blog/2019/12/02/rust-2020/?utm_source=atom_feed
published: "2019-12-02T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/12/02/rust-2020/
---
...
[Yosh’s #rust2020 post](https://blog.yoshuawuyts.com/rust-2020/) covered this topic quite well, I think. In
the [timeline section](https://blog.yoshuawuyts.com/rust-2020/#timeline), he breaks down the time available, concluding with:
...
companies experimenting with Rust](https://www.rust-lang.org/static/pdfs/Rust-Tilde-Whitepaper.pdf), looking for a way to boost
...
investment in Rust itself. [Microsoft](https://internals.rust-lang.org/t/update-on-the-ci-investigation/10056/9?u=nikomatsakis) and [Amazon](https://aws.amazon.com/blogs/opensource/aws-sponsorship-of-the-rust-project/), for example, are
...
post](https://xampprocky.github.io/public/blog/rust-2021/),
...
post on [“More than coders”](http://smallcultfollowing.com/babysteps/blog/2019/04/15/more-than-coders/). The plain fact is that this kind of
time is often unavailable on a volunteer basis.

# Shifting the focus from _adoption_ to _investment_
...
[Parity’s #rust2020 post](https://www.parity.io/rust-2020/), and I was particularly struck by
...
question is about a broader initiative – think of the [Sealed Rust](https://ferrous-systems.com/blog/sealed-rust-the-pitch/)
...
[shepherding](http://smallcultfollowing.com/babysteps/blog/2019/09/11/aic-shepherds-3-0/) is taking aim at.)
...
contributors](https://rust-lang.github.io/rfcs/2689-compiler-team-contributors.html), and we introduced other innovations like the
[weekly design meetings](https://rust-lang.github.io/compiler-team/about/steering-meeting/). These meetings have meant not only that we
...
works. The lang team is [publishing its minutes](https://github.com/rust-lang/lang-team/tree/master/minutes) and
(frequently) recordings of our meetings, which are also open for
anyone to attend; the core team is also [publishing recordings](https://github.com/rust-lang/core-team/blob/master/minutes/core-team/meetings.md) on
a best effort basis. The intrastructure team has made great strides in
documenting their procedures on [forge](https://github.com/rust-lang/core-team/tree/master/minutes/project-leadership-sync), as have other
teams. At the project level, we introduced the [leadership sync\
meeting](https://github.com/rust-lang/core-team/tree/master/minutes/project-leadership-sync), the [Inside Rust blog](https://blog.rust-lang.org/inside-rust/), and we’ve been trying to
get a [governance-focused WG](https://blog.rust-lang.org/inside-rust/2019/11/13/goverance-wg-cfp.html) off the ground.
...
- active mentorship to help leads formulate roadmaps and plans, as was
  discussed in the [recent compiler-team retrospective](https://rust-lang.github.io/compiler-team/minutes/design-meeting/2019-11-16-Working-Group-Retrospective/)
- documenting all of our governance procedures and other details on [forge](https://github.com/rust-lang/core-team/tree/master/minutes/project-leadership-sync)
- more transparency about our priorities, and a clearer process for
  requesting that something be _made_ into a priority
- improving _followthrough_ and avoiding [unbounded queues](http://smallcultfollowing.com/babysteps/blog/2019/07/10/aic-unbounded-queues-and-lang-design/); when
...
- We’ve succeeded at encouraging Rust _adoption_, and we should start thinking about encouraging _investment_.
