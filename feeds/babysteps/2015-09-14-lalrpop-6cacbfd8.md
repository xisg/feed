---
title: LALRPOP
url: https://smallcultfollowing.com/babysteps/blog/2015/09/14/lalrpop/?utm_source=atom_feed
published: "2015-09-14T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2015/09/14/lalrpop/
---
...
have my morning coffee: [LALRPOP](https://github.com/nikomatsakis/lalrpop) (pronounced like some sort of
strangely accented version of “lollypop”). [LALRPOP](https://github.com/nikomatsakis/lalrpop) is an LR(1)
...
- User-defined macros, so you can [make a macro](https://github.com/nikomatsakis/lalrpop/blob/master/doc/tutorial.md#calculator5) like `Comma<Id>` that
...
[tutorial](https://github.com/nikomatsakis/lalrpop/blob/master/doc/tutorial.md) that introduces LALRPOP in more depth and walks through
...
_That said,_ eventually I would like LALRPOP to support a bunch of
...
[_recursive ascent_](https://en.wikipedia.org/wiki/Recursive_ascent_parser).

Now, as expected, recursive ascent is _supposed_ to be quite fast. In
...
quite a number of parser combinator and PEG libraries: [nom](https://crates.io/crates/nom), [oak](https://crates.io/crates/oak),
[peg](https://crates.io/crates/peg), [nailgun](https://crates.io/crates/nailgun), [peggler](https://crates.io/crates/peggler), [combine](https://crates.io/crates/combine), [parser-combinators](https://crates.io/crates/parser-combinators), and of
course my own [rusty-peg](https://crates.io/crates/rusty-peg) (and probably some others I’ve missed,
sorry). I’m not aware of any other LR(1) (or GLL, GLR, etc)
generators for Rust, but there may well be some. There are also two
LALR parser generators for Rust you may want to check out, [racc](https://github.com/sivadeilra/racc) and
and [lemon\_rust](https://github.com/rodrigorc/lemon_rust).
