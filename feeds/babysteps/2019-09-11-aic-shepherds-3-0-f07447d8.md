...
url: https://smallcultfollowing.com/babysteps/blog/2019/09/11/aic-shepherds-3-0/?utm_source=atom_feed
published: "2019-09-11T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/09/11/aic-shepherds-3-0/
---
...
to be moving a feature forward[1](#fn:1), then it should have a **shepherd** (or
multiple) who is in charge of doing that.

In order to avoid [unbounded queues](http://smallcultfollowing.com/babysteps/blog/2019/07/10/aic-unbounded-queues-and-lang-design/), the **number of things that any**
...
queues](http://smallcultfollowing.com/babysteps/blog/2019/07/10/aic-unbounded-queues-and-lang-design/) and was, I think, a crucial flaw in the Shepherds 1.0 system.
...
My model is that shepherds are how we _quantify and manage the things_
_we are doing_. The question of “what happens to all the existing
things” is more a question of _how we select which things to do_ –
...
the future. This might then indicate ideas that we do _not_ want to
...
us making more use of [collaborative summary documents](http://smallcultfollowing.com/babysteps/blog/2019/04/22/aic-collaborative-summary-documents/), which allow
...
- We’ll post on the [lang team repository](https://github.com/rust-lang/lang-team/) the list of active shepherds and their assigned areas.
