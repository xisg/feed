...
url: https://smallcultfollowing.com/babysteps/blog/2012/07/13/concurrent-maps/?utm_source=atom_feed
published: "2012-07-13T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/07/13/concurrent-maps/
---

# Concurrent maps

I had a very interesting discussion with Sriram and Terrence (of
[Kilim](http://www.malhar.net/sriram/kilim/) and [ANTLR](http://www.antlr.org/) fame, respectively—two smart
...
_wrong_ with such data structures, but if we can avoid shared, mutable
...
traditional [monitors](http://en.wikipedia.org/wiki/Monitor_%28synchronization%29).
