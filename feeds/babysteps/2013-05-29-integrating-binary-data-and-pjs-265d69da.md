...
url: https://smallcultfollowing.com/babysteps/blog/2013/05/29/integrating-binary-data-and-pjs/?utm_source=atom_feed
published: "2013-05-29T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/05/29/integrating-binary-data-and-pjs/
---

# Integrating binary data and PJs

We’ve been making a lot of _conceptual_ progress with the PJS API that
...
described [the subset of JS](https://smallcultfollowing.com/babysteps/
/blog/2013/04/30/parallelizable-javascript-subset/) that we expect to parallelize in
a previous post).
...
[binary data specification](http://wiki.ecmascript.org/doku.php?id=harmony:binary_data). For those of you not familiar with
...
to add an optional _out pointer_ parameter to the binary data APIs.
...
_Update:_ I realized I forgot to write about safety concerns. You
