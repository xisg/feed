...
url: https://smallcultfollowing.com/babysteps/blog/2019/07/08/async-await-status-report-2/?utm_source=atom_feed
published: "2019-07-08T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/07/08/async-await-status-report-2/
---
...
- the [`Future`](https://doc.rust-lang.org/std/future/trait.Future.html) trait, which defines the core future protocol (stabilized in [1.36.0](https://blog.rust-lang.org/2019/07/04/Rust-1.36.0.html)!);
- basic async-await syntax;
- a “first edition” of [the “async Rust” book](https://rust-lang.github.io/async-book/index.html).

### The future trait

The first of these bullets, the future trait, was stabilized in the
[1.36.0](https://blog.rust-lang.org/2019/07/04/Rust-1.36.0.html) release. This is important because the [`Future`](https://doc.rust-lang.org/std/future/trait.Future.html) trait is the
...
can write free functions like this one:[1](#fn:1)
...
pass as arguments to helpers like [`runtime::spawn`](https://docs.rs/runtime/0.3.0-alpha.5/runtime/fn.spawn.html):
...
rejuvenating [the “async Rust” book](https://rust-lang.github.io/async-book/index.html). This book covers the nuts
...
standard books like [The Rust Programming Language](https://doc.rust-lang.org/book/), but in the
...
- **A core set of async traits and combinators.** Basically a 1.0
  version of the [futures-rs repository](https://github.com/rust-lang-nursery/futures-rs), offering key interfaces
  like `AsyncRead`.
- **Better stream support.** The [futures-rs repository](https://github.com/rust-lang-nursery/futures-rs) contains
  a `Stream` trait, but there remains some “support work” to make it
  better supported. This may include [some form of for-await\
  syntax](https://boats.gitlab.io/blog/post/for-await-i/) (although that is not a given).
...
since my first post – we’ve closed over [40 blocker issues](https://github.com/rust-lang/rust/issues?q=is%3Aissue+label%3AAsyncAwait-Blocking+is%3Aclosed)! I want
...
look at our [list of blocking issues](https://github.com/rust-lang/rust/labels/AsyncAwait-Blocking). Anything that is not
assigned is fair game! Just find an issue you like that is not
assigned and use [`@rustbot claim`](https://github.com/rust-lang/triagebot/wiki/Assignment) to claim it. You can find
out more about how our working group works on [the async-await working\
group page](https://github.com/rust-lang/compiler-team/tree/master/working-groups/async-await). In particular, that page includes a link to the
[calendar event](https://calendar.google.com/calendar/r/eventedit/copy/NjQzdWExaDF2OGlqM3QwN2hncWI5Y2o1dm5fMjAxOTA2MTFUMTcwMDAwWiA2dTVycnRjZTZscnR2MDdwZmkzZGFtZ2p1c0Bn/bmlrb21hdHNha2lzQGdtYWlsLmNvbQ?scp=ALL&pli=1&sf=true) for our weekly meeting, which takes place in the
[the `#wg-async-foundations` channel on the rust-lang Zulip](https://rust-lang.zulipchat.com/#narrow/stream/187312-wg-async-foundations) –
...
\[rouge\]: [https://github.com/rouge-ruby/rouge](https://github.com/rouge-ruby/rouge) [↩︎](#fnref:1)

2. I culled this list by browsing the closed issues and who they were assigned to. I’m sorry if I forgot someone or minimized your role! Let me know and I’ll edit the post. <3 [↩︎](#fnref:2)
