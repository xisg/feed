...
url: https://smallcultfollowing.com/babysteps/blog/2012/02/02/breaking-out-is-hard-to-do/?utm_source=atom_feed
published: "2012-02-02T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/02/02/breaking-out-is-hard-to-do/
---
...
bug on this issue ( [#1619](https://github.com/mozilla/rust/issues/1619)) and it seems like the general
...
rules aren’t quite subtle enough. It’s only _mostly_ invisible. For example:
...
Of course, if we actually _used_ `all()` instead of `iter_brk` that’d be
