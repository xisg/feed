...
url: https://smallcultfollowing.com/babysteps/blog/2015/05/29/classes-strike-back/?utm_source=atom_feed
published: "2015-05-29T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2015/05/29/classes-strike-back/
---

# Virtual Structs Part 2: Classes strike back

This is the second post summarizing my current thoughts about ideas
related to “virtual structs”. In the [last post](http://smallcultfollowing.com/babysteps/blog/2015/05/05/where-rusts-enum-shines/), I described how,
...
cleaned up and simplified version of the [real thing](https://github.com/rust-lang/rust/blob/9854143cba679834bc4ef932858cd5303f015a0e/src/librustc/middle/ty.rs#L1359-L1397)).
...
[added the arena](https://github.com/rust-lang/rust/pull/1759) back before we even had lifetimes at all, and
used to use unsafe pointers here. The fact that we use proper
lifetimes here is thanks to the awesome [eddyb](https://github.com/eddyb/) and his super duper
[safe-ty](https://github.com/rust-lang/rust/pull/18483) branch. What a guy.)
...
still large. To fix this, [Huon](https://github.com/huonw) [spent quite a bit of time](https://github.com/rust-lang/rust/pull/19549) analyzing the size of each variant
...
_all_ variants have common fields, it’s a lot more awkward to handle a
case like `Struct` or `Enum`, where only _some_ of the variants have
common fields.
...
there is no way to write a fn that initializes _only_ the common
fields.

C++ and Java take a different approach to initialization based on
_constructors_. The idea of a constructor is that you first allocate
...
[different proposal](http://smallcultfollowing.com/babysteps/blog/2012/08/24/datasort-refinements/) in the past, and, somewhat amusingly, my
[very first post](http://smallcultfollowing.com/babysteps/blog/2011/12/02/why-case-classes-are-better-than-variant-types/) on this blog was on this topic as well. I
...
enum variants into types. There have [been proposals](https://github.com/rust-lang/rfcs/issues/349) along these
