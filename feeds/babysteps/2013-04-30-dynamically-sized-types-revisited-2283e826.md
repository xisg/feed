...
url: https://smallcultfollowing.com/babysteps/blog/2013/04/30/dynamically-sized-types/?utm_source=atom_feed
published: "2013-04-30T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/04/30/dynamically-sized-types/
---
...
Note that I have divided the types into two groups. _Sized_ types
indicate values whose size is known to the compiler. _Unsized_ types
represent values whose size is _not_ known the compiler (this
...
_and_ all the efficiency and flexibility of the current system. The
