...
url: https://smallcultfollowing.com/babysteps/blog/2012/04/15/syntax-matters-dot-dot-dot/?utm_source=atom_feed
published: "2012-04-15T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/04/15/syntax-matters-dot-dot-dot/
---
...
[“syntax matters”](https://www.google.com/search?q=syntax%20matters).
...
I think there is a deeper sense in which syntax _can_ matter.
...
grandiously, referred to as the [“homoiconic”](http://en.wikipedia.org/wiki/Homoiconicity) property.
...
looks like this, `foo.open("abc", write, read)`, the reader _thinks_
...
old colleague of mine [described in a paper](http://mp.binaervarianz.de/issta2011.pdf). But this error
is unthinkable in Smalltalk, as you would have to write `foo openFile:"abc" read:write write:read`, making it quite clear that
something was amiss.
...
matter at all. But mostly it’s a matter of _familiarity_. Like
...
It is important, however, to distinguish between _syntax_ and
_expressiveness_. I don’t care (too much) whether you write
...
_Aside #1:_ It is too bad that the genuine advantages of
...
_Aside #2:_ In case you can’t tell, I’m partially responding to the
...
favorite is [this one](http://news.ycombinator.com/item?id=3826528), which seems to imply that we Rust
developers are involved in some kind of conspiracy—as if we _prefer_
...
_Aside #3:_ To be clear, I don’t think Rust’s syntax is anything
