...
url: https://smallcultfollowing.com/babysteps/blog/2026/03/22/max-min-view-types-followup/?utm_source=atom_feed
published: "2026-03-22T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2026/03/22/max-min-view-types-followup/
---
...
Interestingly, the autoderef loop already considers visibility: if you do `a.foo`, we will deref until we see a _`foo` field visible to you at the current point_.
...
What I expect is that this would _just_ swap the selected fields ( `messages`, in this case) and leave the other fields untouched.
