...
url: https://smallcultfollowing.com/babysteps/blog/2013/03/20/a-tour-of-the-parallel-js-implementation/?utm_source=atom_feed
published: "2013-03-20T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/03/20/a-tour-of-the-parallel-js-implementation/
---
...
information. However, we can only _get_ accurate type information by
...
the _slice_, a unit of work, and the _worker thread_—today there is
...
_warmup mode_. As will be explained in the next section, we expect
...
invoking the callback `fjFunc` _sequentially_ (i.e., with the normal
...
_bailout_, meaning that it will attempt some action that is not
...
This note describes the code as it is found on [our branch](https://github.com/syg/iontrail).
