...
- “Tune up” the layout, but keep the cute picture![3](#fn:3)
...
- [https://github.com/nikomatsakis/babysteps](https://github.com/nikomatsakis/babysteps)
- [https://github.com/nikomatsakis/nikomatsakis-babysteps-theme](https://github.com/nikomatsakis/nikomatsakis-babysteps-theme)
...
Send me an [email](mailto:niko@alum.mit.edu?subject=babysteps+to+beauty) with your name, some examples of past work, any recommendations etc, and the rate you charge. Thanks!

* * *

1. On the other hand, it has that super cute picture of my daughter (from around a decade ago, but still…). And the content, I like to think, is decent. [↩︎](#fnref:1)

2. I have a soft spot for wacky plurals, and “desiderata” might be my fave. I heard it first from a Dave Herman presentation to TC39 and it’s been rattling in my brain ever since, wanting to be used. [↩︎](#fnref:2)

3. Ooooh, I always want nice looking tables like those wizards who style github have. How come my tables are always so ugly? [↩︎](#fnref:3)
