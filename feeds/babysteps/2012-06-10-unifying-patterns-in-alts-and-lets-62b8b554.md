...
url: https://smallcultfollowing.com/babysteps/blog/2012/06/10/unifying-patterns-in-alts-and-lets/?utm_source=atom_feed
published: "2012-06-10T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/06/10/unifying-patterns-in-alts-and-lets/
---
...
very useful to _move_ out of the discriminant in an `alt`, but that is
...
The proposal is to distinguish between _copying bindings_ and
_reference bindings_. A copying binding, indicating by either a
...
As a bonus, this idea transparently permits data to be _moved_ as part
...
Basically, if the discriminant is _moved_ into the alt then its pieces
