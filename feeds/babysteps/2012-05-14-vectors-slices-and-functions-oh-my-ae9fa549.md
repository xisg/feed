...
url: https://smallcultfollowing.com/babysteps/blog/2012/05/14/vectors/?utm_source=atom_feed
published: "2012-05-14T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/05/14/vectors/
---
...
_Note:_ I think this idea of having fixed-length arrays and tuples be
...
- types like `@fn(int) -> uint` and `@vec<int>` seem to have a clear
  meaning once you are accustomed to `@` meaning pointer, vs `fn@(int) -> uint` and `[int]/@`;
