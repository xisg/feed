...
url: https://smallcultfollowing.com/babysteps/blog/2019/12/11/async-interview-2-cramertj-part-3/?utm_source=atom_feed
published: "2019-12-11T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/12/11/async-interview-2-cramertj-part-3/
---

# Async Interview #2: cramertj, part 3

This blog post is continuing [my conversation with\
cramertj](http://smallcultfollowing.com/babysteps/blog/2019/12/09/async-interview-2-cramertj/). This
will be the last post.

In the [first post](http://smallcultfollowing.com/babysteps/blog/2019/12/09/async-interview-2-cramertj/), I covered what we said about Fuchsia,
interoperability, and the organization of the futures crate.

In the [second post](http://smallcultfollowing.com/babysteps/blog/2019/12/10/async-interview-2-cramertj-part-2/), I covered cramertj’s take on the [`Stream`](https://docs.rs/futures-core/0.3.1/futures_core/stream/trait.Stream.html),
[`AsyncRead`](https://docs.rs/futures/0.3.1/futures/io/trait.AsyncRead.html), and [`AsyncWrite`](https://docs.rs/futures/0.3.1/futures/io/trait.AsyncWrite.html) traits. We also discused the idea of
[attached](http://smallcultfollowing.com/babysteps/blog/2019/12/10/async-interview-2-cramertj-part-2/#terminology-note-detachedattached-instead-of-streaming) streams and the imporance of GATs for modeling those.
...
want to be “ [attached](http://smallcultfollowing.com/babysteps/blog/2019/12/10/async-interview-2-cramertj-part-2/#terminology-note-detachedattached-instead-of-streaming) closures”.
...
action. Instead, when you call the closure, you get back a _future_
the performs the action; that _future_ is going to need to have a
...
closures are basically [“attached”](http://smallcultfollowing.com/babysteps/blog/2019/12/10/async-interview-2-cramertj-part-2/#terminology-note-detachedattached-instead-of-streaming) closures which return a value that
...
- We could stabilize [`AsyncRead`](https://docs.rs/futures/0.3.1/futures/io/trait.AsyncRead.html) and [`AsyncWrite`](https://docs.rs/futures/0.3.1/futures/io/trait.AsyncWrite.html) and resolve the
...
- [`Stream`](https://docs.rs/futures-core/0.3.1/futures_core/stream/trait.Stream.html) and async closures would benefit from being “attached”,
...
- Similarly, until the async closures story is more complete, we
  ...
  the stdlib. Auxiliary libraries like [`futures`](https://github.com/rust-lang-nursery/futures-rs/) allow us to
  introduce such functions and later make changes.
- The `select!` macro is cool and everybody should read the
  [async book chapter](https://rust-lang.github.io/async-book/06_multiple_futures/03_select.html) to learn why. =)
