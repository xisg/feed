...
url: https://smallcultfollowing.com/babysteps/blog/2012/05/28/moving-mutability-into-the-type/?utm_source=atom_feed
published: "2012-05-28T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/05/28/moving-mutability-into-the-type/
---

# Moving mutability into the type

I am dissatisfied with how mutability is treated in the Rust type
system. The current system is that a _type_ is not prefixed mutable;
...
_immutable arrays_. The type `[A]` basically means “an array of
...
The reason is that we distinguish between two types being _assignable_
and _subtyping_. This is already necessary for handling region
pointers. Basically, _assignability_ would ignore interior and unique
