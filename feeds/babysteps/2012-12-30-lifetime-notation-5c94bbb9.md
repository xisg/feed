...
url: https://smallcultfollowing.com/babysteps/blog/2012/12/30/lifetime-notation/?utm_source=atom_feed
published: "2012-12-30T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/12/30/lifetime-notation/
---
...
`StringReader` type has a _lifetime parameter_ named `self`. In other
...
`Foo/&self<T>`, which is generic over both a lifetime `self` _and_ a
type `T`.
...
_before_ the `&`, as we originally had it. This is required to make
parsing unambiguous.
