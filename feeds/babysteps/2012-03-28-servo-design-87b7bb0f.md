---
title: Servo design
url: https://smallcultfollowing.com/babysteps/blog/2012/03/28/servo-design/?utm_source=atom_feed
published: "2012-03-28T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/03/28/servo-design/
---
...
own experiments as well as feedback from [Ben Lerner](http://www.cs.brown.edu/~blerner/), we
decided this is not the best approach.

An alternative that we are considering instead is what we call the RCU
approach. The name derives from the [read-copy-update](http://en.wikipedia.org/wiki/Read-copy-update) pattern
used extensively in the Linux kernel. The idea itself was also
inspired by the work on [Concurrent Revisions](http://research.microsoft.com/apps/pubs/default.aspx?id=132619) by Burckhardt et
al. at MSR.
...
[traditional persistent data structures](http://en.wikipedia.org/wiki/Persistent_data_structure) like maps and vectors
...
[Concurrent Revisions](http://research.microsoft.com/apps/pubs/default.aspx?id=132619) work—that might work out well.
