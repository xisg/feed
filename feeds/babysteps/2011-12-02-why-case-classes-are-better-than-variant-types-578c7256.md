...
url: https://smallcultfollowing.com/babysteps/blog/2011/12/02/why-case-classes-are-better-than-variant-types/?utm_source=atom_feed
published: "2011-12-02T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2011/12/02/why-case-classes-are-better-than-variant-types/
---
...
My goal in writing Scala code was to _never_ have an `assert false` to
...
first, which is _very_ common, is that you want to have some helper
...
The key here is that `BinOp` and `UnOp` are _automatically_ types of
