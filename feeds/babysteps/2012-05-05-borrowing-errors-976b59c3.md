...
url: https://smallcultfollowing.com/babysteps/blog/2012/05/05/borrowing-errors/?utm_source=atom_feed
published: "2012-05-05T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/05/05/borrowing-errors/
---

# Borrowing errors

I implemented a simple, non-flow-sensitive version of the reference
checker which I described in [my previous post](https://smallcultfollowing.com/babysteps/
/blog/2012/05/01/borrowing). Of course it
...
In fact, _all_ of the errors I see right now (about 46 of them across
...
[Haller and Odersky’s work on uniqueness](http://lampwww.epfl.ch/~phaller/capabilities.html), though I’m sure the
...
[“fail-fast iterators”](http://stackoverflow.com/questions/4479554/why-vector-methods-iterator-and-listiterator-are-fail-fast)).
...
of _any_ state, including data interior to the stack frame; we should
[fix this regardless](https://github.com/mozilla/rust/issues/1422)). However, drawing on
[more work by the Scala folks](http://infoscience.epfl.ch/record/175240/files/ecoop_1.pdf), we can actually generalize pure
...
modifications to aliasable state _except possibly through closures_
_which the caller itself provided_.
...
As I said in my [previous post](https://smallcultfollowing.com/babysteps/
/blog/2012/05/01/borrowing), I am not 100% sure of what analysis
