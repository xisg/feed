...
url: https://smallcultfollowing.com/babysteps/blog/2019/12/03/aic-improving-the-pre-rfc-process/?utm_source=atom_feed
published: "2019-12-03T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/12/03/aic-improving-the-pre-rfc-process/
---
...
[draft](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md) of an RFC already, but this blog post aims to introduce the
idea and some of the motivations. The key idea of the RFC is formalize
the steps leading _up_ to an RFC, as well as to capture the lang team
...
In a nutshell, the [proposal](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md) is this:

- When you see a problem you think we should try to solve, you open an
  issue on the [lang-team](https://github.com/rust-lang/lang-team/) repository. This is called a **[proposal issue](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md#proposal-issues)**.
- In the **[proposal issue](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md#proposal-issues)**, you include a description of the problem
  and a link to a thread on [internals](https://internals.rust-lang.org/) where the problem is being
  discussed.
...
- The lang-team [periodically reviews those issues](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md#reviewing-proposals). If someone on the
  team likes the idea, we will create a “project group” around the
  design. Each project group has a repository, a [lang team liaison](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md#lang-team-liason), and
  one or more [shepherds](https://github.com/nikomatsakis/project-staged-rfcs/blob/master/rfcs/0001-shepherded-rfcs.md#shepherds). The repository houses the draft RFC and
...
the eRFC idea that [we used for coroutines](https://github.com/rust-lang/rfcs/blob/master/text/2033-experimental-coroutines.md) but never
formalized.)
...
we are actively working on, and I think we should devote _most_ of our
...
Second, sometimes there are nice ideas like [RFC 2580](https://github.com/rust-lang/rfcs/pull/2580). These ideas
...
good limit. The [Shepherding 3.0](http://smallcultfollowing.com/babysteps/blog/2019/09/11/aic-shepherds-3-0/) blog post had more notes on
this topic.
...
decision, we should be creating a [summary document](http://smallcultfollowing.com/babysteps/blog/2019/04/22/aic-collaborative-summary-documents/) that describes
...
[FFI-unwind project group](https://github.com/rust-lang/project-ffi-unwind), for example, is pursuing an attempt to
decide on the rules regarding unwinding across FFI boundaries. And, as
I noted in [my post announcing the Async Interviews](http://smallcultfollowing.com/babysteps/blog/2019/11/22/announcing-the-async-interviews/), I’d like
...
series](https://internals.rust-lang.org/t/aic-adventures-in-consensus/9843).
