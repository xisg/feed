---
title: Borrowing
url: https://smallcultfollowing.com/babysteps/blog/2012/05/01/borrowing/?utm_source=atom_feed
published: "2012-05-01T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/05/01/borrowing/
---
...
do alias analysis but which _does_ track which parts of the stack
...
becomes _temporarily immutable_ during the loop.
...
we assume that every [aliasable value escapes](http://en.wikipedia.org/wiki/Escape_analysis)). So that means we
...
variables can be _moved_ (sent, for example, to another thread). So
...
arguments). This feature _is_ handy, and I’m a big fan of making
...
1. the compiler does a flow-insensitive analysis with respect to which
   references exist. _All_ of the examples in the previous section
