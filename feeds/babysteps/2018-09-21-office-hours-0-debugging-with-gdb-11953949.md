...
url: https://smallcultfollowing.com/babysteps/blog/2018/09/21/office-hours-0-debugging-with-gdb/?utm_source=atom_feed
published: "2018-09-21T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2018/09/21/office-hours-0-debugging-with-gdb/
---

# Office Hours #0: Debugging with GDB

This is a report on the first [“office hours”](https://github.com/nikomatsakis/office-hours), in which we
...
( [esprit](https://github.com/vramana/esprit)). When running `cargo test`, some of the tests would panic,
...
final `Running` line. In this particular project ( [esprit](https://github.com/vramana/esprit)), we needed
...
command, as shown below. After setting the break, _then_ we can run:
...
callers’ state. You may also enjoy the [“TUI mode”](https://sourceware.org/gdb/onlinedocs/gdb/TUI.html). Anyway, I’m
...
tool](https://rr-project.org/) to get **reversible debugging**. `rr` basically extends gdb
...
here](https://github.com/mozilla/rr/wiki/Usage). (There is also [Huon’s old blog post](https://huonw.github.io/blog/2015/10/rreverse-debugging/), which
...
– I filed [#54433](https://github.com/rust-lang/rust/issues/54433) about using `rust-gdb` and `rr replay`, so maybe
