...
url: https://smallcultfollowing.com/babysteps/blog/2014/07/06/implied-bounds/?utm_source=atom_feed
published: "2014-07-06T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2014/07/06/implied-bounds/
---
...
bounds declared in _type_ declarations to avoid repetition in `fn` and
`impl` declarations.
...
allows the fn to _assume_ that the bounds are satisfied. The net
...
as argument _implies_ that `K:Hash`. With the proposed change,
...
In fact, we [already have a similar rule](http://smallcultfollowing.com/babysteps/blog/2013/04/04/nested-lifetimes/) for
...
traits, as described in [this blog post](http://smallcultfollowing.com/babysteps/blog/2013/04/04/nested-lifetimes/).

### Detailed design

#### Well-formed types and the BOUNDS function

We say that a type is _well-formed_ if all of its bounds are met. We
...
For references, the type must have a suitable _lower bound_:
...
described in [my prior blog post](http://smallcultfollowing.com/babysteps/blog/2013/04/04/nested-lifetimes/).
