...
url: https://smallcultfollowing.com/babysteps/blog/2013/10/24/iterators-yielding-mutable-references-take-2/?utm_source=atom_feed
published: "2013-10-24T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/10/24/iterators-yielding-mutable-references-take-2/
---

# Iterators yielding mutable references, take 2

OK, after writing the
[post on iterators that yield mutable references](http://smallcultfollowing.com/babysteps/blog/2013/10/24/iterators-yielding-mutable-references/), and discussing
...
[when we were initially discussing iterators](https://mail.mozilla.org/pipermail/rust-dev/2013-June/004428.html). In that context,
...
the iterator in place so that _it no longer contains a way to reach_
_the value you just returned_.
...
_Side note:_ It is not necessary to use the pattern matching let
...
With respect to the question I posed in [my previous post](http://smallcultfollowing.com/babysteps/blog/2013/10/24/iterators-yielding-mutable-references/), this
