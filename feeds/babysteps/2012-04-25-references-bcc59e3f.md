---
title: References
url: https://smallcultfollowing.com/babysteps/blog/2012/04/25/references/?utm_source=atom_feed
published: "2012-04-25T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/04/25/references/
---
...
and other badness. The key invariant that _borrowing_ maintains is
...
_An aside:_ I believe that in the current implementation of the
...
_Note:_ It’s possible that the `/&` might become inferred in the
...
for a type written `&a.T`, where `a` is some kind of _lifetime_. The
