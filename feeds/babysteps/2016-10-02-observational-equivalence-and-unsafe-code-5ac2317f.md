...
url: https://smallcultfollowing.com/babysteps/blog/2016/10/02/observational-equivalence-and-unsafe-code/?utm_source=atom_feed
published: "2016-10-02T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2016/10/02/observational-equivalence-and-unsafe-code/
---

# Observational equivalence and unsafe code

I spent a really interesting day last week at Northeastern University.
First, I saw a fun talk by Philip Haller covering [LaCasa](http://2016.splashcon.org/event/splash-2016-oopsla-lacasa-lightweight-affinity-and-object-capabilities-in-scala), which is a
...
Next, I met with [Amal Ahmed](http://www.ccs.neu.edu/home/amal/) and her group to discuss the process of
...
course – this _is_ C – to shoot yourself in the foot (for example,
...
[can have much worse effects if you try to combine it with other unsafe abstractions](https://www.reddit.com/r/rust/comments/508pkb/unleakable_crate_safetysanityrefocus/d72703d). Imagine
for example that you are using [Rayon](https://github.com/nikomatsakis/rayon/): Rayon relies on running
...
independently seemed _safe_ but wound up with a broken system. How did
...
This is where we get back to this notion of _observational_
_equivalence_. After all, both Rayon and setjmp/longjmp give the user
some new powers:
...
talking about _Safe Rust_ as it was a monolithic entity, we’ll
...
Where do you queue up the data?), but it seems _almost_ true.
...
things. Not quite how to think about _that_ yet.
