...
url: https://smallcultfollowing.com/babysteps/blog/2017/01/22/assigning-blame-to-unsafe-code/?utm_source=atom_feed
published: "2017-01-22T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2017/01/22/assigning-blame-to-unsafe-code/
---
...
My personal favorite is [valgrind](http://valgrind.org/), but there are a number of
...
hopefully _efficiently_ executable) is that, in the (paraphrased)
...
limited form of the kind of checks I have in mind: [miri](https://github.com/solson/miri), the MIR
interpreter created by [Scott Olson](https://github.com/solson/) and now with
[significant contributions](https://github.com/solson/miri/graphs/contributors) by [Oliver Schneider](https://github.com/oli-obk). If you haven’t seen
...
as a kind of blob of bytes of a certain size. But it doesn’t _only_
...
similar to what tools like [valgrind](http://valgrind.org/) and [electric fence](http://elinux.org/Electric_Fence) do as well.)
...
[Robby Findler’s thesis on Behavioral Software Contracts](https://www.eecs.northwestern.edu/~robby/pubs/papers/behavioral-software-contracts.pdf). That’s
...
Jesse Tov’s [Alms language](http://users.eecs.northwestern.edu/~jesse/pubs/dissertation/) allocated stateful proxies to allow
...
[_Big types in little runtime_](http://dl.acm.org/citation.cfm?id=3009849), Michael Vitousek, Cameron
...
applicable to this setting: we have control over the _safe Rust_ code
...
_executable_ way. Specifically, I think we should specify predicates
...
like [valgrind](http://valgrind.org/), which would allow us to apply these rules even around
