...
url: https://smallcultfollowing.com/babysteps/blog/2019/01/07/rust-in-2019-focus-on-sustainability/?utm_source=atom_feed
published: "2019-01-07T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/01/07/rust-in-2019-focus-on-sustainability/
---
...
processes: most recently, boat’s post on [organizational debt](https://boats.gitlab.io/blog/post/rust-2019/), along
with [Florian’s series of posts](https://yakshav.es/rust-2019/), did a great job of crystallizing
...
have [argued before](http://smallcultfollowing.com/babysteps/blog/2018/06/20/proposal-for-a-staged-rfc-process/), I think we would benefit from making
these stages a more explicit part of the process (much as e.g. the
[TC39](https://github.com/tc39/proposals) and [WebAssembly](https://github.com/WebAssembly/proposals) groups already do).
...
are doing _now_ and it’s more obvious when we are making decisions
about what we should do _next_. I am also calling for more redundancy.
...
of the [rustdoc](https://doc.rust-lang.org/nightly/nightly-rustc/rustc/?search=&search=) and [rustc-guide](https://rust-lang.github.io/rustc-guide/) variety. It also means finishing up
things we started but never quite finished, like replacing the
remaining uses of [`NodeId`](https://doc.rust-lang.org/nightly/nightly-rustc/syntax/ast/struct.NodeId.html) with the newer [`HirId`](https://doc.rust-lang.org/nightly/nightly-rustc/rustc/hir/struct.HirId.html). In some cases,
...
pursue](https://internals.rust-lang.org/t/next-steps-for-reducing-overall-compilation-time/8429/2?u=nikomatsakis) here, and frankly a lot of them are blocked on needing
