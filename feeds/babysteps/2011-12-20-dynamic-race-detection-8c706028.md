...
url: https://smallcultfollowing.com/babysteps/blog/2011/12/20/dynamic-race-detection/?utm_source=atom_feed
published: "2011-12-20T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2011/12/20/dynamic-race-detection/
---
...
a _parallel region_ and a set of _parallel tasks_. Each task is created within
some parallel region; when the parallel region is _executed_, all of
...
Now, the key idea: I want to say that each object is _owned_ by the
task which creates it. The data is then mutable only by its owner and
any parent task of the owner. The data is _readable_ by the owner and
...
an object and when you create it, you say it is _mobile_. What you get
