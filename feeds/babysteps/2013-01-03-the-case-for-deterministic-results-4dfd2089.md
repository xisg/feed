...
url: https://smallcultfollowing.com/babysteps/blog/2013/01/03/the-case-for-deterministic-results/?utm_source=atom_feed
published: "2013-01-03T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/01/03/the-case-for-deterministic-results/
---
...
[Roc in this comment](http://smallcultfollowing.com/babysteps/blog/2013/01/02/deterministic-or-not/#comment-753987533)) is that while the intention of a
...
use a cheap PRNG like [Xorshift](http://en.wikipedia.org/wiki/Xorshift) in the sequential fallback so as
...
_However,_ it is also true that bailouts are the exceptional case: if
...
and not even _attempt_ parallelism.

So, at least in the case of functions like `map()`, efficiency in the
_steady state_ should not be negatively impacted by deterministic
...
efficiency, we _can_ choose a deterministic ordering that still
...
If the API were designed for _me personally_ to use, I would want it
