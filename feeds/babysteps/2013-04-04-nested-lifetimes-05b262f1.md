...
url: https://smallcultfollowing.com/babysteps/blog/2013/04/04/nested-lifetimes/?utm_source=atom_feed
published: "2013-04-04T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/04/04/nested-lifetimes/
---

# Nested lifetimes

While working on [issue #5656](https://github.com/mozilla/rust/issues/5656) I encountered an interesting
...
Now we can introduce a second kind of cursor, one that doesn’t _own_
...
_b_ uffer. Everything seems fine, but when I tried running this
...
is the lifetime of the _cursor_. Our pointer is a pointer into the
_buffer_, so it will have the lifetime `'b`.
