...
url: https://smallcultfollowing.com/babysteps/blog/2018/11/08/splash-2018-mid-week-report/?utm_source=atom_feed
published: "2018-11-08T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2018/11/08/splash-2018-mid-week-report/
---
...
Direct Instruction in Programming Education”](https://2018.splashcon.org/event/splash-2018-keynotes-explicit-direct-instruction-in-programming-education). The basic gist of
...
leaving a lot of folks in the cold and may be at least _partly_
...
chords[1](#fn:1) – it kind of sets them up to fail.
...
more natural. Moreover, I _suspect_ that there are common “stages of
...
download here to learn more](https://2018.splashcon.org/event/plateau-2018-papers-identifying-barriers-to-adoption-for-rust-through-online-discourse)). Specifically, they’ve been
...
responses to my previous post about _interprocedural conflicts_, I
realized that this one _fundamental conflict_ can manifest in a number
...
_Borrow Checker Field Guide_. The idea would be to distinguish:
...
Chris Granger gave an [amazing and heartfelt talk about the Eve effort](https://2018.splashcon.org/event/live-2018-papers-keynote)
...
first, that the _crux_ of programming is _modeling and_
_feedback_. Excel works for so many people because it gives a simple
...
about [their work on incremental datalog](https://2018.splashcon.org/event/splash-2018-splash-i-better-living-through-incrementality-immediate-static-analysis-feedback-without-loss-of-precision). They had a very cool
...
Ballantyne about how [Chalk](https://github.com/rust-lang-nursery/chalk) works. We discussed some details of how
...
gave me an exciting pointer to something called [“default logic”](https://en.wikipedia.org/wiki/Default_logic),
...
1. My daughter insists she can do this… let’s just say she’s lucky she’s so cute. =) [↩︎](#fnref:1)
