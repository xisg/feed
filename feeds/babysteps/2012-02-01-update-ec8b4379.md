---
title: Update
url: https://smallcultfollowing.com/babysteps/blog/2012/02/01/update/?utm_source=atom_feed
published: "2012-02-01T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/02/01/update/
---
...
The most exciting to me has been [#1493](https://github.com/mozilla/rust/issues/1493), which vastly improved
our performance when working with thread-local boxes. There is still
[work to be done on box performance](https://github.com/mozilla/rust/issues/1737), but before taking any next
...
first step to
[simplifying some of the scarier parts of the Rust runtime](https://github.com/mozilla/rust/issues/1739).
...
[an earlier blog post](https://smallcultfollowing.com/babysteps/
/blog/2011/12/29/composing-blocks/). Making it nice to use will require a
[lighter bind syntax](https://github.com/mozilla/rust/issues/1649), which I’ve almost got complete now.
This also (as a side effect) improves our type inference somewhat.
One final thing I’d like to do is integrate support for
[break and cont](https://github.com/mozilla/rust/issues/1619) into the library, though some details remain to
be discussed there.
...
[last few posts](https://smallcultfollowing.com/babysteps/
/blog/2012/01/09/parallel-javascript/). First, the parallel JavaScript work now
has an official name: the [PJs project](https://github.com/nikomatsakis/pjs). That github project is
not that useful at the moment, though: I am in the process of moving
the code from an [older GitHub project](https://github.com/nikomatsakis/pjs-old) into the new one
...
I have also had some discussions with the [Rivertrail](https://github.com/RiverTrail/RiverTrail)
...
Finally, I drew up a [Java-based prototype](https://github.com/nikomatsakis/patpar) of the API as well
as the [static type system that I described earlier](https://smallcultfollowing.com/babysteps/
/blog/2011/12/09/pure-blocks/). Having
