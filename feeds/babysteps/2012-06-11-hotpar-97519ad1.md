---
title: HotPar
url: https://smallcultfollowing.com/babysteps/blog/2012/06/11/hotpar/?utm_source=atom_feed
published: "2012-06-11T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/06/11/hotpar/
---

# HotPar

Last Thursday and Friday I had the good fortune of presenting a paper
of mine at [HotPar 2012](https://www.usenix.org/conference/hotpar12). The paper is called
[Parallel Closures: A New Twist on an Old Idea](https://www.usenix.org/conference/hotpar12/parallel-closures-new-twist-old-idea); it basically
...
on [specializing memory layout for NUMA architectures](https://www.usenix.org/conference/hotpar12/template-library-integrate-thread-scheduling-and-locality-management-numa), in which
...
most important factor in getting good performance is _data_
_organization and access patterns_. And yet this is completely ignored
...
is, one of the outright _goals_ in my work was to support current
...
distinguish _parallel closures_, in which the encapsulated environment
is read-only, from _traditional, sequential closures_, which have full
...
[Disciplined Concurrent Programming Using Tasks with Effects](https://www.usenix.org/conference/hotpar12/disciplined-concurrent-programming-using-tasks-effects)
...
A system like
[Disciplined Concurrent Programming Using Tasks with Effects](https://www.usenix.org/conference/hotpar12/disciplined-concurrent-programming-using-tasks-effects), in
particular, will require the ability to _reify_ the effects, thus
...
So what does a more _data-aware_ parallel model look like? I am not
...
APIs like [RiverTrail](https://www.usenix.org/conference/hotpar12/parallel-programming-web) also fit well into this paradigm. You have an
