...
url: https://smallcultfollowing.com/babysteps/blog/2012/05/29/simple-effect-system/?utm_source=atom_feed
published: "2012-05-29T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/05/29/simple-effect-system/
---
...
used for everything from ensuring [consistent lock use](http://pmg.csail.mit.edu/pubs/boyapati04safejava-abstract.html) to
[bridging functional and imperative software](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.62.534) to
[supporting safe, live updates of running software](http://drum.lib.umd.edu/handle/1903/7494?mode=simple), and that’s
...
`Runnable` _throw_, anyhow? Obviously it’s impossible to say, as the
interface can be used for any number of things.

The traditional solution to this problem is to allow _effect_
_parameterization_. If you’re not careful, though, the sickness can
...
here is _not_ a type parameter, but an effect parameter: its value, so
...
My basic idea (inspired by [Lightweight Polymorphic Effects](http://infoscience.epfl.ch/record/175240/files/ecoop.pdf)) is
