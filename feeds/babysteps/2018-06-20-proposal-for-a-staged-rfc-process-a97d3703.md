...
url: https://smallcultfollowing.com/babysteps/blog/2018/06/20/proposal-for-a-staged-rfc-process/?utm_source=atom_feed
published: "2018-06-20T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2018/06/20/proposal-for-a-staged-rfc-process/
---
...
recommend reading aturon’s [excellent](http://aturon.github.io/2018/05/25/listening-part-1/) [blog](http://aturon.github.io/2018/06/02/listening-part-2/) [posts](http://aturon.github.io/2018/06/18/listening-part-3/) on
this topic.
...
process](https://tc39.github.io/process-document/), but adapting them to Rust’s needs. I’m pretty excited
about it.
...
discuss the ideas here, [I opened an internals thread](https://internals.rust-lang.org/t/blog-post-proposal-for-a-staged-rfc-process/7766).
...
- **Explicit RFC stages.** Each proposal moves through a [series of\
  explicit stages](https://docs.google.com/drawings/d/11KtHLYsqJzi2_Y3mOBz2FbXeG3verSHz-PFBuiwYIQw/edit?usp=sharing).
...
- **Prioritization is now an explicit part of the process.** The new
  ...
  there are often RFCs which are _good ideas_, but which are not a
  good idea _right now_, and the current process doesn’t give us a way
  to specify that.
- **There is more room for feedback on the final, implemented**
  **design.** In the new process, once implementation is complete, there
  ...
  done this before – such as cramertj’s [call for feedback on `impl Trait`](https://internals.rust-lang.org/t/help-test-impl-trait/6516),
...
_current_ process by which an idea becomes a stable feature. This goes
...
- **Stabilization:** The final step is to move to stabilize. This is
  ...
  stabilized. (An example of such an issue is [#48453](https://github.com/rust-lang/rust/issues/48453), which
...
view this [directly on Gooogle drawings](https://docs.google.com/drawings/d/11KtHLYsqJzi2_Y3mOBz2FbXeG3verSHz-PFBuiwYIQw/edit?usp=sharing), where the
oh-so-important emojis work better):

![](https://smallcultfollowing.com/babysteps/
/assets/2018-06-20-rfc-stages.svg)
...
like a [summary comment](https://github.com/rust-lang/rfcs/pull/1909#issuecomment-327565150) today. This issue can go through an FCP
...
Please leave comments in [the internals thread for this post](https://internals.rust-lang.org/t/blog-post-proposal-for-a-staged-rfc-process/7766).

### Credit where credit is due

This proposal is heavily shaped by [the TC39 process](https://tc39.github.io/process-document/). This
particular version was largely drafted in a big group discussion with
[wycats](https://twitter.com/wycats), [aturon](https://github.com/aturon), [ag\_dubs](https://twitter.com/ag_dubs/), [steveklabnik](https://github.com/steveklabnik/), [nrc](https://github.com/nrc/), [jntrnr](https://twitter.com/jntrnr/),
[erickt](https://github.com/erickt/), and [oli-obk](https://github.com/oli-obk/), though earlier proposals also involved a few
others.
