...
url: https://smallcultfollowing.com/babysteps/blog/2019/07/10/aic-unbounded-queues-and-lang-design/?utm_source=atom_feed
published: "2019-07-10T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/07/10/aic-unbounded-queues-and-lang-design/
---

# AiC: Unbounded queues and lang design

I have been thinking about how language feature development works in
Rust[1](#fn:1). I wanted to write a post about what I see as one of the
...
languishes. To me, the poster child for this is [RFC 66](https://rust-lang.github.io/rfcs/0066-better-temporary-lifetimes.html) – a modest
...
[sitting around unimplemented](https://github.com/rust-lang/rust/issues/15023) since **June of 2014**. At this
...
precise[2](#fn:2). It needed somebody from the compiler team (maybe me
...
In the [2018 RustConf keynote](https://www.youtube.com/watch?v=J9OFQm8Qf1I), we talked about the contrast between
...
proposed](https://github.com/rust-lang/rfcs/pull/1210) in July of **2015**. We had a lot of really
...
satisfactory conclusion. Then, in Feb of **2018**, [I had an idea](http://smallcultfollowing.com/babysteps/blog/2018/02/09/maximally-minimal-specialization-always-applicable-impls/)
which [aturon then extended](http://aturon.github.io/tech/2018/04/05/sound-specialization/) in April. It _seems_ like these ideas
...
worked out reasonably well for us, but probably not _optimally_. I
think in an ideal world we would have found some _useful subset_ of
...
link to the [Adventures in Consensus thread on internals](https://internals.rust-lang.org/t/aic-adventures-in-consensus/9843).

One thing that has been pointed out to me is that these ideas resemble
a number of management philosophies, most notably [kanban](https://en.wikipedia.org/wiki/Kanban). I don’t
...
1. I’m coming at this from the perspective of the lang team, but I think a lot of this applies more generally. [↩︎](#fnref:1)

2. For that matter, it would be helpful if there were a spec of the current behavior for it to build off of. [↩︎](#fnref:2)
