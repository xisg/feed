...
url: https://smallcultfollowing.com/babysteps/blog/2014/09/11/attribute-and-macro-syntax/?utm_source=atom_feed
published: "2014-09-11T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2014/09/11/attribute-and-macro-syntax/
---

# Attribute and macro syntax

A few weeks back pcwalton introduced a [PR](https://github.com/pcwalton/rfcs/blob/unify-attributes-and-macros/active/0000-unify-attributes-and-macros.md) that aimed to move the
...
worth trying to reserve `!` and `?` for _something_ related to
...
not _dangerous_. They can be mildly surprising, in that they don’t
...
[Issue #3740](https://github.com/rust-lang/rust/issues/3740) for more details.) Token trees seem like the
...
_An aside:_ it occurs to me that to make this possible before 1.0 as I
...
normal. Similarly, our parser is actually not defined over a _stream_
of tokens but rather a _token tree_.
