...
url: https://smallcultfollowing.com/babysteps/blog/2013/04/02/associated-items/?utm_source=atom_feed
published: "2013-04-02T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/04/02/associated-items/
---
...
trait design is _forwards compatible_: that is, I expect that we will
...
_associated items_ (e.g., associated types, constants, functions,
...
associated item _is_ and what you might want to use it for, and it
...
Notice that the definition of `Node` has moved _inside_ the trait.
