...
url: https://smallcultfollowing.com/babysteps/blog/2012/10/12/extending-the-definition-of-purity-in-rust/?utm_source=atom_feed
published: "2012-10-12T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2012/10/12/extending-the-definition-of-purity-in-rust/
---
...
among you, this is effectively an effect-parametric system with _very_
...
saying that a pure function will not modify _anything_ the caller can
...
We can’t say that the function `each()` modifies _nothing_, because it
...
information—after all, `each()` does not _itself_ mutate anything
that the user has access to. It’s the _callback_ which does! So
...
[Rivertrail- or PJs-like model](https://smallcultfollowing.com/babysteps/
/blog/2012/10/10/rivertrail/) for data parallelism to Rust. The
...
in this [HotPar paper](https://www.usenix.org/conference/hotpar12/parallel-closures-new-twist-old-idea) that I wrote some time back (note
...
[Issue #3722](https://github.com/mozilla/rust/issues/3722): right now, a pure function is permitted to mutate
