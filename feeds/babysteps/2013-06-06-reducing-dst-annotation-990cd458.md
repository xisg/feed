...
url: https://smallcultfollowing.com/babysteps/blog/2013/06/06/reducing-dst-annotation/?utm_source=atom_feed
published: "2013-06-06T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/06/06/reducing-dst-annotation/
---

# Reducing DST Annotation

So Ben Blum has doing [some investigation](https://github.com/mozilla/rust/issues/6308#issuecomment-18880575) into the full
...
/blog/2013/04/30/dynamically-sized-types/) post. It’s clear that, if we change
...
to alternative proposals, like the [fn vs thunk](https://smallcultfollowing.com/babysteps/
/blog/2013/06/03/more-on-fns/) post or
[bblum’s proposal](https://github.com/mozilla/rust/issues/6308#issuecomment-18880575) which changes `[&|@|~]fn` to `fn[&|@|~]`,
...
would not change, but it _feels_ like a violation in spirit. We are
...
[properly support deriving](https://github.com/mozilla/rust/issues/6308#issuecomment-18866391) this way. You might think that
...
type? Of course, _we_ know that in practice `ArrayMessage` is only
