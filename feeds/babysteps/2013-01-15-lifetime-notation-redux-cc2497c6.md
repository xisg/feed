...
url: https://smallcultfollowing.com/babysteps/blog/2013/01/15/lifetime-notation-redux/?utm_source=atom_feed
published: "2013-01-15T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/01/15/lifetime-notation-redux/
---

# Lifetime notation redux

In a [previous post](https://smallcultfollowing.com/babysteps/
/blog/2012/12/30/lifetime-notation/) I outlined some of the options for updating our
...
lifetimes (options 7 and 8 in my [previous post](https://smallcultfollowing.com/babysteps/
/blog/2012/12/30/lifetime-notation/)). As a reminder,
...
whitespace sensitivity, so that `StringReader{self}` and `StringReader {self}` are parsed differently, but whitespace sensitivity is
