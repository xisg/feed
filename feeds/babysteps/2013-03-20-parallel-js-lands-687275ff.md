...
url: https://smallcultfollowing.com/babysteps/blog/2013/03/20/parallel-js-lands/?utm_source=atom_feed
published: "2013-03-20T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/03/20/parallel-js-lands/
---

# Parallel JS lands

The [first version of our work on ParallelJS](https://bugzilla.mozilla.org/show_bug.cgi?id=829602) has just been
...
recently extended to support _moving_ typed arrays from place to
place, though there is still no way for multiple workers to _share_ a
...
`ParallelArray` type or instead [attach methods to Array](https://smallcultfollowing.com/babysteps/
/blog/2013/02/26/splitting-the-pjs-api/)? How
_should_ we specify the [semantics](http://smallcultfollowing.com/babysteps/blog/2013/01/02/deterministic-or-not/) of parallel execution,
[precisely](http://smallcultfollowing.com/babysteps/blog/2013/01/03/the-case-for-deterministic-results/)? I expect that once we have good prototypes
...
like the [PJs](http://smallcultfollowing.com/babysteps/blog/2012/01/09/parallel-javascript/) API I have talked about before. Part of the goal
