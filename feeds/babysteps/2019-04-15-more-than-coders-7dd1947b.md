...
url: https://smallcultfollowing.com/babysteps/blog/2019/04/15/more-than-coders/?utm_source=atom_feed
published: "2019-04-15T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2019/04/15/more-than-coders/
---
...
more and more I’m thinking about all the _other_ jobs that go into
...
- **Publicity** – talking about what’s going on, tweeting about
  ...
  [steveklabnik](https://twitter.com/steveklabnik/), but for rustc.
...
In [my keynote at Rust LATAM](https://nikomatsakis.github.io/rust-latam-2019/#1), I quoted quite liberally from an
excellent blog post by Jessica Lord, [“Privilege, Community, and Open\
Source”](http://jlord.us/blog/osos-talk.html). There’s one passage that keeps coming back to me:

> We also need an open source _whenever_. Not enough people can or
...
do it well – and I think the more _ways_ we can create for people to
contribute, the more people will be _able_ to contribute.
...
[the compiler-team repository](https://github.com/rust-lang/compiler-team). There is also a [central\
calendar](https://github.com/rust-lang/compiler-team#meeting-calendar) that lists all the group meetings and so forth. This
...
working on [rustc-guide](https://rust-lang.github.io/rustc-guide/) chapters, for example, showing the major
...
however, really require _writing the PRs in question_ – in fact,
...
Going back to [Jessica Lord’s post](http://jlord.us/blog/osos-talk.html), she continues:
...
In my last quote from [Jessica Lord’s post](http://jlord.us/blog/osos-talk.html), I left out the
...
people be members of _both_ the release team _and_ the compiler
...
[steering meetings](https://github.com/rust-lang/compiler-team/blob/master/about/steering-meeting.md), or perhaps the weekly meetings
of the [meta working group](https://github.com/rust-lang/compiler-team/tree/master/working-groups/meta), or just ping me over on [the\
rust-lang Zulip](https://github.com/rust-lang/compiler-team/blob/master/about/chat-platform.md).
