...
url: https://smallcultfollowing.com/babysteps/blog/2013/05/13/mutable-fn-alternatives/?utm_source=atom_feed
published: "2013-05-13T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2013/05/13/mutable-fn-alternatives/
---
...
environment, but then I realize that per the DST proposal any `&mut fn` could be borrowed to `&fn`, and so that would not be sound.

### Remove everything but borrowed closures

We could just _only have_ borrowed closures. The type would be written
...
Procedures could probably _always_ be single-shot (that is, `once`).
...
is not _necessary_ (as an aside, I had hoped to write some today about
