...
url: https://smallcultfollowing.com/babysteps/blog/2017/05/02/gnome-class-integrating-rust-and-the-gnome-object-system/?utm_source=atom_feed
published: "2017-05-02T00:00:00Z"
feed: babysteps
guid: https://smallcultfollowing.com/babysteps/blog/2017/05/02/gnome-class-integrating-rust-and-the-gnome-object-system/
---
...
_borrowing_ that ref, and it you want to store that `Foo*` value
...
other words, you will always get a _shared_ reference to your data.
...
to be incremented and decremented even when aliased. It _does_ imply
...
Therefore, the GNOME model works a bit differently. While you _can_
...
through [PRs like #40939](https://github.com/rust-lang/rust/pull/40939).
...
[the repository](https://github.com/nikomatsakis/gnome-class) over the next little while with various ideas
