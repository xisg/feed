...
feed: danluu
guid: https://danluu.com/monorepo/
---
...
>
> **Me**: I think engineers at FB and Google are probably familiar with using smaller repos (doesn't [Junio Hamano](http://en.wikipedia.org/wiki/Junio_Hamano) work at Google?), and they still prefer a single huge repo for \[reasons\].
>
...
> …
> As a result of this state of affairs (more speculation), there is a complexity barrier in open source that has not changed significantly in the last few years. This creates a gap between what is easily obtainable at a company like Google versus a\[n\] open sourced project.
