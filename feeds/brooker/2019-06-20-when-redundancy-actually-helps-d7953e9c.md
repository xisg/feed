...
url: http://brooker.co.za/blog/2019/06/20/redundancy.html
published: "2019-06-20T00:00:00Z"
feed: brooker
guid: http://brooker.co.za/blog/2019/06/20/redundancy
---
...
Andrew (or Kerry Lee, I’m not sure which) introduced this to the EBS team as _don’t be weird_.
...
> 2/ Modality is bad
>
> — Andrew Certain (@tacertain) [July 20, 2019](https://twitter.com/tacertain/status/1152460786171707393?ref_src=twsrc%5Etfw)
...
When systems suffer partial failure, it’s often hard to tell what’s _healthy_ and what’s _unhealthy_. In fact, different systems in different parts of the network often completely disagree on health. If your system sees partial failure and fails over towards the truly _unhealthy_ side, you’re in trouble. The complexity here comes from the distributed systems fog of war: telling the difference between bad networks, bad software, bad disks, and bad NICs can be surprisingly hard. Often, systems flap a bit before falling over.
