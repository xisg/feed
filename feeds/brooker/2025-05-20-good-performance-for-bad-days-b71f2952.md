...
feed: brooker
guid: http://brooker.co.za/blog/2025/05/20/icpe
---

# Good Performance for Bad Days

Good things are good, one finds.
...
_Not Measuring the Hard Stuff_
...
1. Most cloud systems are _open_ (APIs, web sites, web services, MCP servers, whatever)
2. Most benchmarks are _closed_ (TPC-C, YCSB, etc)
...
_Disconnect between benchmark and real-world workloads_
