...
url: http://brooker.co.za/blog/2019/05/01/emergent.html
published: "2019-05-01T00:00:00Z"
feed: brooker
guid: http://brooker.co.za/blog/2019/05/01/emergent
---
...
A classic cloud architecture is built of small clusters of nodes (typically one to nine[1](#foot1)), with coordination used inside
...
and many designs are not robust in cases where coordination is required for large-scale operations. Results like CAP and CALM[2](#foot2) provide clear tools for thinking through when coordination must occur, but offer little help in understanding the dynamic behavior of the system when it does occur.
...
2. See [Keeping CALM: When Distributed Consistency is Easy](https://arxiv.org/pdf/1901.01930.pdf) by Hellerstein and Alvaro. It’s a great paper, and a very powerful conceptual tool.
