...
feed: brooker
guid: http://brooker.co.za/blog/2021/08/11/arecibo
---
...
I hope so too. While I’ve never worked in radio astronomy, my PhD supervisor and a number of my colleagues were involved in [MeerKAT](https://en.wikipedia.org/wiki/MeerKAT) [1](#foot1) and [HERA](https://en.wikipedia.org/wiki/Hydrogen_Epoch_of_Reionization_Array), so I developed a real interest in the field. I’d love to see radio, and radar, astronomy gain a great new instrument.
