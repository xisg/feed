...
url: http://brooker.co.za/blog/2020/01/02/why-distributed.html
published: "2020-01-02T00:00:00Z"
feed: brooker
guid: http://brooker.co.za/blog/2020/01/02/why-distributed
---
...
I grew up reading John Carmack’s .plan file. His stories about the development of Doom, Quake and the rest were a formative experience for me, and a big reason I was interested in computers beyond just gaming[1](#foot1). I was a little bit disappointed to see this tweet:
...
>
> — John Carmack (@ID\_AA\_Carmack) [December 28, 2019](https://twitter.com/ID_AA_Carmack/status/1210997702152069120?ref_src=twsrc%5Etfw)
...
1. Along with hacking on [gorillas.bas](https://github.com/GorillaStack/gorillas/blob/master/gorillas.bas).
2. Which is a real thing. In [Disk failures in the real world: what does an MTTF of 1,000,000 hours mean to you?](https://www.usenix.org/legacy/events/fast07/tech/schroeder/schroeder.pdf) Schroeder and Gibson report that _Time between replacement, a proxy for time between failure, is not well modeled by an exponential distribution and exhibits significant levels of correlation, including autocorrelation and long-range dependence._ This situation hasn’t improved since 2007.
3. I guess you can [search for primes](https://www.mersenne.org/), or mine Ethereum, or something else. Unfortunately, these activities are seldom economically interesting.
