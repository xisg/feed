...
feed: brooker
guid: http://brooker.co.za/blog/2025/09/18/firecracker
---
...
> An LLM agent runs tools in a loop to achieve a goal.[1](#foot1)
...
There’s a bit more plumbing that’s needed to make some things [like random numbers](https://github.com/firecracker-microvm/firecracker/blob/main/docs/snapshotting/random-for-clones.md) work correctly in the cloned VMs[2](#foot2).
