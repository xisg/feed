...
feed: brooker
guid: http://brooker.co.za/blog/2025/12/15/database-for-ssd
---
...
> What does a relational database designed _specifically_ for local SSDs look like?
...
B-Trees versus LSM-trees vs B-Tree variants versus LSM variants versus other data structures are trade-offs that have a lot to do with access patterns and workload patterns. Picking a winner would be a whole series of blog posts, so I’m going to chicken out and say _its complicated_.
