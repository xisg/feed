...
feed: brooker
guid: http://brooker.co.za/blog/2024/06/04/scale
---
...
_One Machine Is All You Need?_
...
Many very important workloads _can_ fit on one such machine.

Or could, if scale was all we cared about.

_It’s Not Just Scale_
...
- Utilization. Multi-tenant systems [achieve lower costs and higher utilization](https://brooker.co.za/blog/2023/03/23/economics.html) by packing multiple diverse workloads onto the same resources. This works in two ways: it allows workloads on different seasonal cycles to share resources in the shorter-term, and allows systems with unpredictable load spikes (or failure recovery spikes) to share spare _burst_ resources. This allows both faster recovery, and significantly improved peak-to-average ratios. In many practical systems the efficiency wins from improving the peak-to-average ratio exceed the opportunities to tune single-machine systems for greater efficiency.
...
_Simplicity is a System Property_
