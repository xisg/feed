...
feed: nullprogram
guid: urn:uuid:91357133-9d2d-4a6f-9b39-4bd1d35c814e
---

# I have officially retired from Emacs

This article was discussed [on reddit](https://old.reddit.com/r/emacs/comments/1svziwa) and [on Hacker News](https://news.ycombinator.com/item?id=47906651).

This past Tuesday I typed `C-x C-c` in Emacs for the last time after 20
years of daily use. Though [nearly half that time](/blog/2017/04/01/) was gradually
...
my [newly-acquired superpowers](/blog/2026/03/29/) I could knock out the last two pieces
in a few days’ work, namely [`M-x calc`](/blog/2009/06/23/) with **[stackcalc](https://github.com/skeeto/stackcalc)** and
[Elfeed](/blog/2013/09/04/) with **[Elfeed2](https://github.com/skeeto/Elfeed2)**. I’m especially excited about the
...
These [actively-in-use](https://melpa.org/#/?q=skeeto) packages require new maintainers (apply on
...
work, and that I _already had the feed reader I wanted_, made motivation
...
While [Dear ImGui](https://github.com/ocornut/imgui) was the right choice for [dcmake](https://github.com/skeeto/dcmake), it would not be
...
via CMake `FetchContent`. That naturally led to [wxWidgets](https://wxwidgets.org/). While it
...
Unlike Dear ImGui, wxWidgets is a platform, including [sane](/blog/2021/12/30/) I/O and
path handling. I _mostly_ don’t need platform layers when building
applications like these. I can simply rely on wxWidgets’ utilities.

Both of these projects build out-of-the-box on [w64devkit](https://github.com/skeeto/w64devkit) thanks to the
