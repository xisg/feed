...
feed: nullprogram
guid: urn:uuid:355dfc03-0e7c-4bae-92fe-5b52174de325
---
...
with the beginner stuff, then _without disrupting the original linked_
_list_, enhance it with new capabilities.
...
table avoids redundancy by _sharing structure with the list_. Because it’s
...
etc. All the above code is available ready to run: [`list.c`](https://gist.github.com/skeeto/493823d5956dfdc1d95d8c390c2b0e1d).
