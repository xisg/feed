...
feed: nullprogram
guid: urn:uuid:eb448519-0a55-4c1c-bc55-17a65634224f
---

# dcmake: a new CMake debugger UI

CMake has a [`--debugger` mode](https://cmake.org/cmake/help/latest/manual/cmake.1.html#cmdoption-cmake-debugger) since [3.27](https://cmake.org/cmake/help/latest/release/3.27.html#debugger) (July 2023),
...
to debug at that point. However, it _does_ work with `-P` [script mode](https://cmake.org/cmake/help/latest/manual/cmake.1.html#cmdoption-cmake-P)
