...
feed: nullprogram
guid: urn:uuid:d2b53f8d-88a6-400b-a748-693a758741c5
---
...
Still, it got the wheels spinning and I realized an _almost_ practical
...
I’d normally use `long` for all these integers because Linux is [LP64](https://en.wikipedia.org/wiki/64-bit_computing#64-bit_data_models)
...
_almost_ works correctly! Here’s what I get on Debian 13:
...
On Linux `stack` is [the initial value of the stack pointer](/blog/2025/03/06/), which
[points to `argc`, `argv`, `envp`, and `auxv`](https://articles.manugarg.com/aboutelfauxiliaryvectors). We’ll need construct
...
Where [`cmdline_to_argv8` is my Windows argument parser](/blog/2022/02/18/), already
...
Running _this same binary_ on Windows after installing zlib in w64devkit:
