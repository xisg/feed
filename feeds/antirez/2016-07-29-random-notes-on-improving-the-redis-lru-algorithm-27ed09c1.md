...
feed: antirez
guid: http://antirez.com/news/109
---
...
http://redis.io/images/redisdoc/lru\_comparison.png
...
counter during accesses to the keys:
 ...
 uint8\_t LFULogIncr(uint8\_t counter) {

 if (counter == 255) return 255;

 double r = (double)rand()/RAND\_MAX;

 double baseval = counter - LFU\_INIT\_VAL;

 if (baseval < 0) baseval = 0;

 double p = 1.0/(baseval\*server.lfu\_log\_factor+1);
...
[Comments](http://antirez.com/news/109)
